...
export const PROVIDER_METADATA: Record<string, AIProviderMetadata> = {
  openrouter: {
    ...
    description: '通过单个 API 访问 200+ 个模型。灵活性和免费层级俱佳。',
    requiresApiKey: true,
  ...
  groq: {
    ...
    name: 'Groq',
    displayName: 'Groq',
    description: '采用 LPU 技术的超快推理。慷慨的免费层级。',
    requiresApiKey: true,
    ...
    freeTierLimits: {
      ...
      description: '免费层级：每分钟 30 次请求、3 万 token',
    },
    supportsCORS: true,
    requiresProxy: false,
    supportsStreaming: true,
  ...
  huggingface: {
    ...
    description: '开源模型。非常适合实验。',
    requiresApiKey: true,
    apiKeyUrl: 'https://huggingface.co/settings/tokens',
    apiKeyLabel: 'HuggingFace 访问令牌',
    hasFreeModels: true,
    freeModelIds: ['mistralai/Mistral-7B-Instruct-v0.2'],
    freeTierLimits: {
      requestsPerDay: 1000,
      description: '速率限制取决于模型热度',
    },
    supportsCORS: true,
    requiresProxy: false,
  ...
  mistral: {
    ...
    description: '欧洲 AI。符合 GDPR，模型高效。',
    requiresApiKey: true,
  ...
  gemini: {
    ...
    description: 'Google 的多模态 AI。上下文窗口大。',
    requiresApiKey: true,
    ...
    freeTierLimits: {
      ...
      requestsPerDay: 1500,
      description: '免费层级：每分钟 60 次请求、每天 1500 次请求',
    },
    supportsCORS: true,
    requiresProxy: false,
    supportsStreaming: true,
  ...
  openai: {
    ...
    name: 'OpenAI',
    displayName: 'OpenAI',
    description: '业界领先的模型。需要付费 API 密钥。',
    requiresApiKey: true,
  ...
  anthropic: {
    ...
    description: 'Claude 模型。最适合推理和安全。',
    requiresApiKey: true,
  ...
  openrouter: [
    {
      ...
      description: '最新的 Llama 3.3 70B。综合性能出色。',
    },
    {
  ...
  groq: [
    {
      ...
      requiresApiKey: true,
      useCases: ['chat', 'code', 'reasoning'],
      description: '最快的 Llama 3.3 70B 推理。',
    },
    {
