...
const QUEST_TEMPLATES: QuestTemplate[] = [
  ...
  },
  {
    type: 'use-categories',
    title: (n) => `使用 ${n} 个不同类别`,
    description: (n) => `今天完成来自 ${n} 个不同类别的习惯`,
    icon: '🎨',
    xpReward: 65,
